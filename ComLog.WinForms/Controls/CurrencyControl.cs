...
{
    public partial class CurrencyControl : UserControl, ICurrencyView
    {
        private readonly IPresenter _presenter;
        private bool _isEventHandlerSets;

        public CurrencyControl(ICurrencyDataMаnager currencyDataMаnager, IDataMаnager dataMаnager)
        {
            InitializeComponent();
            _presenter = new CurrencyPresenter(this, currencyDataMаnager, dataMаnager);
        }
